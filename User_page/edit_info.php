...
<style>
    .stdInfo{
        ...
        height:900px;padding-top:140px;
    }
    .updateProfile{
        height:550px;
...
if($_SESSION["login_user"]){
    $sql = "SELECT * FROM students WHERE userName = '$_SESSION[login_user]'";
...
<div class="form-group">
  ...
  <div class="form-group">
    <label for="rollno"><strong>RollNo</strong></label>
    <input type="text" class="form-control" id="roll" placeholder="" name="rollNos" value = "<?php echo $RollNo;?>">
  </div>
...
if(isset($_POST["update-profile"])){
  ...
  $q = "UPDATE students SET fname = '$first',lname ='$last',userName='$userName',rollNo='$RollNo',phoneNo='$phoneNo',
