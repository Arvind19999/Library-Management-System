...
style="border-bottom:3px blue solid;position:fixed; width:100%;">
 ...
 <em> &nbsp;LMS</em></a>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <li class="nav-item p-0 my-1" style="font-size:1.1rem; text-transform: uppercase;">
       <a class="nav-link" href="../User_page/User_signUp.php">
       <img src="../images/profile_pic.png" alt="profile picture"
       style="height:35px;width:35px;border-radius:50%;padding:0px;margin:0px;"
       >
       </a>
     </li>
     <li class="nav-item p-1 my-1" style="font-size:1.1rem; text-transform: uppercase;">
       <a class="nav-link" href="../User_page/User_signUp.php">Logme out</a>
     </li>
</ul>  
